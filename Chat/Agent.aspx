...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        chat.client.showAvailableAgent = function (json) {
            var jsonObject = JSON.parse(json);
            $('.topRow').val("");
            $('.topRow').append(arrayToGrid(jsonObject));
        };
        ...
        $.connection.hub.start().done
            (function () {
                ...
                $("#btn").click(function () {
                    chat.server.populateAgent($('#name').val(), $('#email').val());
                    $("#login").hide();
                    $('#container').show();
                });
...
<body>
    <div id="login">
        Name:
        <input id="name" type="text" value="Agent 1" /><br />
        Email:
        <input id="email" type="text" value="agent1@officeclip.com" /><br />
